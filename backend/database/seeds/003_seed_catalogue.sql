...
INSERT INTO simulation_catalogue (simulation_id, category_route, age_group, level_order, duration, badge) VALUES
  ...
  -- ── financial-security ──────────────────────────────────────────
  ('fs-v-otp-1',    'financial-security', 'student',      1, '10 min', 'New'),
  ('fs-v-kyc-1',    'financial-security', 'professional', 1, '10 min', 'New'),
  ('fs-v-otp-1',    'financial-security', 'professional', 2, '10 min', 'New'),
  ('fs-v-invest-1', 'financial-security', 'professional', 3, '12 min', 'New'),
  ('fs-v-kyc-1',    'financial-security', 'elderly',      1, '10 min', 'New'),
  ('fs-v-otp-1',    'financial-security', 'elderly',      2, '10 min', 'New'),
  ('fs-v-lottery-1','financial-security', 'elderly',      3, '10 min', 'New'),
  ('fs-v-pension-1','financial-security', 'elderly',      4, '10 min', 'New'),
  ...
  ('ceo-v-exam-desktop-1','career-education-opportunity', 'student',      4, '10 min', 'New'),
  ('ceo-v-giveaway-1',    'career-education-opportunity', 'student',      5, '10 min', 'New'),
