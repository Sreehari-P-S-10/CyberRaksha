    ...
    student: [
      {
        ...
        desc: 'An email attachment promises leaked exam notes. Enabling macros lets a self-replicating virus spread through your contacts — silently, in seconds.',
        duration: '10 min', objectives: ['Understand how macro viruses self-replicate', 'Identify suspicious email attachments', 'Stop a virus from spreading further'],
        badge: 'Interactive',
      },
      {
        id: 'mal-trojan-student', level: 2, difficulty: 'intermediate',
        title: 'Trojan Horse Software',
        desc: 'A cracked game download looks real — professional installer, legit interface. Watch the silent payload execute in the background as you click through.',
        duration: '14 min', objectives: ['Spot fake download sites vs official sources', 'Identify Trojan warning signs during install', 'Respond to a keylogger infection'],
        badge: 'Interactive',
      },
    ],
    professional: [
      {
        ...
        title: 'Computer Virus Infection',
        desc: 'A macro-enabled Word document arrives from a known external contact. Clicking enable triggers a virus that spreads across your organisation\'s email network.',
        duration: '10 min', objectives: ['Identify macro-enabled document risks', 'Prevent a virus from propagating through corporate email', 'Report and contain the infection correctly'],
        badge: 'Interactive',
      },
      {
        id: 'mal-trojan-pro', level: 2, difficulty: 'intermediate',
        title: 'Trojan Horse Software',
        desc: 'A "critical" IT patch arrives as an email attachment. It installs a Remote Access Trojan that hides in background processes and begins exfiltrating data.',
        duration: '14 min', objectives: ['Distinguish legitimate patches from Trojans', 'Detect suspicious background processes', 'Isolate and report a RAT infection'],
        badge: 'Interactive',
      },
      {
        id: 'mal-ransomware-pro', level: 3, difficulty: 'advanced',
        title: 'Ransomware Attack',
        desc: 'A macro in a quarterly report triggers ransomware that encrypts files in real time across your desktop. Every second counts — what do you do first?',
        duration: '18 min', objectives: ['Respond to live ransomware encryption', 'Isolate the machine before network spread', 'Recover using backups — not by paying'],
        badge: 'Interactive',
      },
    ],
    elderly: [
      {
        ...
        title: 'Computer Virus Infection',
        desc: 'An email forward from a trusted contact contains an attachment. Opening it triggers a virus that quietly sends itself to everyone in your contact list.',
        duration: '10 min', objectives: ['Recognise forwarded virus email patterns', 'Understand how viruses use trust to spread', 'Limit the damage after opening a virus'],
        badge: 'Interactive',
      },
      {
        id: 'mal-adware-elderly', level: 2, difficulty: 'beginner',
        title: 'Adware & PUP',
        desc: 'A "free" app outside the Play Store floods your phone with aggressive ads, fake warnings, and request for permissions. See exactly what it is doing.',
        duration: '12 min', objectives: ['Identify rogue apps disguised as utilities', 'Understand what PUPs do to your device', 'Remove adware and protect your phone'],
        badge: 'Interactive',
      },
      {
        id: 'mal-ransomware-elderly', level: 3, difficulty: 'advanced',
        title: 'Ransomware Attack',
        desc: 'A WhatsApp forward claims to be a government virus scanner. Installing it locks your phone with a fake police notice and demands ₹3,500 to unlock.',
        duration: '14 min', objectives: ['Identify government impersonation ransomware', 'Never pay screen-locker ransomware demands', 'Remove mobile ransomware safely'],
        badge: 'Interactive',
      },
    ],
  },
